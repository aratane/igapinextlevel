            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <!-- -->
                        <p style="font-weight: bold;">Kode Anggota : <strong style="color:red;"><?= $row['kode_user']; ?></strong></p>
                        <p style="font-weight: bold;">NIS : <strong style="color: red;"><?= $row['nis']; ?></strong></p>
                        <p style="font-weight: bold;">Nama Lengkap : <strong style="color: red;"><?= $row['fullname']; ?></strong></p>
                        <p style="font-weight: bold;">Nama Pengguna : <strong style="color: red;"><?= $row['username']; ?></strong></p>
                        <p style="font-weight: bold;">Kelas : <strong style="color: red;"><?= $row['kelas']; ?></strong></p>
                        <p style="font-weight: bold;">Alamat Lengkap : <strong style="color: red;"><?= $row['alamat']; ?></strong></p>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
