                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="form-group m-b-2 text-right" style="margin-top: -20px; margin-bottom: -5px;">
                            <button type="button" onclick="tambahSiswa()" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Siswa</button>
                        </div>
                    </div>
                    <!-- /.box-header -->
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalEditSiswa<?php echo $row['id_user']; ?>"><i class="fa fa-edit"></i></a>
                                            <a href="pages/function/Siswa.php?aksi=hapus&id=<?= $row['id_user']; ?>" class="btn btn-danger btn-sm btn-del"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <!-- Modal Edit Siswa -->
                                    <div class="modal fade" id="modalEditSiswa<?php echo $row['id_user']; ?>">
                                            ...
                                            <div class="modal-content" style="border-radius: 5px;">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title" style="font-family: 'Quicksand', sans-serif; font-weight: bold;">
                                                        Edit Siswa ( <?= $row['kode_user']; ?> - <?= $row['fullname']; ?> )
                                                    </h4>
                                                </div>
                                                <form action="pages/function/Siswa.php?aksi=edit" enctype="multipart/form-data" method="POST">
                                                    <div class="modal-body">
                                                        <input type="hidden" value="<?= $row['id_user']; ?>" name="idUser">
                                                        <div class="form-group">
                                                            <label>Kode Siswa <small style="color: red;">* Otomatis Terisi ( Tidak dapat diubah )</small></label>
                                                            <input type="text" class="form-control" value="<?= $row['kode_user'] ?>" name="kodeSiswa" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="kElas">
                                                                ...
                                                                <option value="X - Teknik Kendaraan Ringan dan Otomotif">X - Teknik Kendaraan Ringan dan Otomotif</option>
                                                                <option value="X - Teknik Komputer dan Jaringan">X - Teknik Komputer dan Jaringan</option>
                                                                <option value="X - Teknik Permesinan">X - Teknik Permesinan</option>
                                                                <option value="X - Teknik Bisnis Sepeda Motor">X - Teknik Bisnis Sepeda Motor</option>
                                                                <!-- XI -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="XI - Rekayasa Perangkat Lunak">XI - Rekayasa Perangkat Lunak</option>
                                                                <option value="XI - Teknik Kendaraan Ringan dan Otomotif">XI - Teknik Kendaraan Ringan dan Otomotif</option>
                                                                <option value="XI - Teknik Komputer dan Jaringan">XI - Teknik Komputer dan Jaringan</option>
                                                                <option value="XI - Teknik Permesinan">XI - Teknik Permesinan</option>
                                                                <option value="XI - Teknik Bisnis Sepeda Motor">XI - Teknik Bisnis Sepeda Motor</option>
                                                                <!-- XII -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="XII - Rekayasa Perangkat Lunak">XII - Rekayasa Perangkat Lunak</option>
                                                                <option value="XII - Teknik Kendaraan Ringan dan Otomotif">XII - Teknik Kendaraan Ringan dan Otomotif</option>
                                                                <option value="XII - Teknik Komputer dan Jaringan">XII - Teknik Komputer dan Jaringan</option>
                                                                <option value="XII - Teknik Permesinan">XII - Teknik Permesinan</option>
                                                                <option value="XII - Teknik Bisnis Sepeda Motor">XII - Teknik Bisnis Sepeda Motor</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Alamat </label>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 5px;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" style="font-family: 'Quicksand', sans-serif; font-weight: bold;">Tambah Siswa</h4>
            </div>
            <form action="pages/function/Siswa.php?aksi=tambah" enctype="multipart/form-data" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Kode Siswa <small style="color: red;">* Otomatis Terisi</small></label>
                        <?php
                        include "../../config/koneksi.php";
                        ...
                        $huruf = "SW";
                        $Siswa = $huruf . sprintf("%03s", $urutan);
                        ?>
                        <input type="text" class="form-control" value="<?php echo $Siswa ?>" name="kodeSiswa" readonly>
                    </div>
                    <div class="form-group">
