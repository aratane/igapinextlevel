...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat Datang, <?= $_SESSION['fullname']; ?> di <strong>IGAPIN STUDENT MANAGEMENT SYSTEM.</strong>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                $query_anggota = mysqli_query($koneksi, "SELECT * FROM user WHERE role = 'Siswa'");
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <?php
                include "../../config/koneksi.php";
                $query_anggota = mysqli_query($koneksi, "SELECT * FROM user WHERE role = 'Guru'");
                $row_anggota = mysqli_num_rows($query_anggota);
                ?>
        ...
        <div class="row">
            ...
            <p class="text-center">Alamat : <?= $row['alamat_app']; ?> <br> Email : <?= $row['email_app']; ?> <br> Nomor Telpon : <?= $row['nomor_hp']; ?> </p>
